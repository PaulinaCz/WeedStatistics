...
class BestAveragePriceByYearTest {
    @Test
    void shouldReturnBestPriceForSameYearRecords() {
        //given
        ...
        BestPriceByYear bestAveragePriceByYear = new BestAveragePriceByYear(states);
        //when
        Map<Integer, Optional<State>> result = bestAveragePriceByYear.bestPricePerYear();
